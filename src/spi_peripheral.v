...
module spi_peripheral (
    ...
    output reg [7:0] en_reg_out_7_0, en_reg_out_15_8, en_reg_pwm_7_0, en_reg_pwm_15_8, pwm_duty_cycle
);
    reg [1:0] cs_sync;
    reg [1:0] sclk_sync;
    reg [1:0] copi_sync;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (shift[15]) begin
                case (shift[14:8])
                    7'h00: en_reg_out_7_0  <= shift[7:0];
                    7'h01: en_reg_out_15_8 <= shift[7:0];
                    7'h02: en_reg_pwm_7_0  <= shift[7:0];
                    7'h03: en_reg_pwm_15_8 <= shift[7:0];
                    7'h04: pwm_duty_cycle  <= shift[7:0];
